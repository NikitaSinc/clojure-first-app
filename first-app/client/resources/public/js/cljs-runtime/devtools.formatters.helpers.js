...
var G__10821 = devtools.prefs.pref(v);
v = G__10821;
continue;
} else {
return v;
...
}catch (e10755){var _e__9903__auto__ = e10755;
return false;
}})();
...
}catch (e10757){var _e__9903__auto__ = e10757;
return false;
}})();
...
}catch (e10759){var _e__9903__auto__ = e10759;
return false;
}}
}
});
...
var vec__10786 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10786,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10786,(1),null);
...
return cljs.core.some((function (p1__10793_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10793_SHARP_);
}),template);
});
