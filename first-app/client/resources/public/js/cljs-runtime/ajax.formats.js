...
var G__31380 = request;
var G__31381 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__31380,G__31381) : ajax.formats.get_format.call(null,G__31380,G__31381));
} else {
...
return cljs.core.some((function (p1__31385_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__31385_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__31387){
var map__31388 = p__31387;
var map__31388__$1 = cljs.core.__destructure_map(map__31388);
var request = map__31388__$1;
...
var fexpr__31390 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__31390.cljs$core$IFn$_invoke$arity$1 ? fexpr__31390.cljs$core$IFn$_invoke$arity$1(response) : fexpr__31390.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__31392){
var map__31393 = p__31392;
var map__31393__$1 = cljs.core.__destructure_map(map__31393);
var request = map__31393__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31393__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__31391_SHARP_){
return ajax.formats.get_accept_entries(request,p1__31391_SHARP_);
