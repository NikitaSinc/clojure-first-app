...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11595 = c;
var G__11595__$1 = (((G__11595 == null))?null:G__11595.prototype);
if((G__11595__$1 == null)){
return null;
} else {
return G__11595__$1.reagentRender;
}
})() == null)))));
});
...
var _STAR_current_component_STAR__orig_val__11610 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11611 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11611);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11610);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__11629 = key;
var G__11629__$1 = (((G__11629 instanceof cljs.core.Keyword))?G__11629.fqn:null);
switch (G__11629__$1) {
...
var c = this;
var G__11675_11700 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11675_11700 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11675_11700);
}
...
var renders_11702 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11703 = cljs.core.first(cljs.core.vals(renders_11702));
...
if((cljs.core.count(renders_11702) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11702))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11703)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11703], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
