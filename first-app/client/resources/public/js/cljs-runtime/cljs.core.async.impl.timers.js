...
var i_14132 = (0);
while(true){
if((i_14132 < arr.length)){
(arr[i_14132] = null);

var G__14133 = (i_14132 + (1));
i_14132 = G__14133;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14158 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14158[i]));
} else {
x__$2.forward.push((((i < links_14158.length))?(links_14158[i]):null));
}

if((i < links_14158.length)){
(links_14158[i] = x__$2);
} else {
links_14158.push(x__$2);
}
...
var i_14168 = (0);
while(true){
if((i_14168 <= self__.level)){
var links_14169 = (update[i_14168]).forward;
if((x__$1 === (((i_14168 < links_14169.length))?(links_14169[i_14168]):null))){
(links_14169[i_14168] = (x__$1.forward[i_14168]));

var G__14170 = (i_14168 + (1));
i_14168 = G__14170;
continue;
} else {
var G__14171 = (i_14168 + (1));
i_14168 = G__14171;
continue;
}
} else {
...
var G__14184 = nx;
var G__14185 = (level__$1 - (1));
x = G__14184;
level__$1 = G__14185;
continue;
} else {
var G__14186 = x;
var G__14187 = (level__$1 - (1));
x = G__14186;
level__$1 = G__14187;
continue;
}
