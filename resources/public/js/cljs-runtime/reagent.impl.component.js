...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38920 = c;
var G__38920__$1 = (((G__38920 == null))?null:G__38920.prototype);
if((G__38920__$1 == null)){
return null;
} else {
return G__38920__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38928 = c;
var G__38928__$1 = (((G__38928 == null))?null:G__38928.prototype);
if((G__38928__$1 == null)){
return null;
} else {
return G__38928__$1.render;
}
})() == null)))));
});
...
var G__39136__i = 0, G__39136__a = new Array(arguments.length -  0);
while (G__39136__i < G__39136__a.length) {G__39136__a[G__39136__i] = arguments[G__39136__i + 0]; ++G__39136__i;}
...
G__39134.cljs$lang$applyTo = (function (arglist__39137){
var args = cljs.core.seq(arglist__39137);
...
var or__5045__auto__ = (function (){var G__38941 = c;
var G__38941__$1 = (((G__38941 == null))?null:G__38941.constructor);
if((G__38941__$1 == null)){
return null;
} else {
return G__38941__$1.displayName;
}
})();
...
var G__38942 = c;
var G__38942__$1 = (((G__38942 == null))?null:G__38942.constructor);
if((G__38942__$1 == null)){
return null;
} else {
return G__38942__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38943 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38944 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38944);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38943);
}});
...
var c = this;
var G__39013_39155 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__39013_39155 == null)){
} else {
reagent.ratom.dispose_BANG_(G__39013_39155);
}
...
var renders_39160 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_39161 = cljs.core.first(cljs.core.vals(renders_39160));
...
if((cljs.core.count(renders_39160) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_39160))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_39161)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_39161], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__39031 = o;
reagent.impl.component.goog$module$goog$object.set(G__39031,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__39057 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__39058 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__39058);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__39057);
}});
...
var vec__39071 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39071,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39071,(1),null);
...
var G__39076 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__39076 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__39076);
}
});
}),[]);
