...
}catch (e12926){var _e__9903__auto__ = e12926;
return false;
...
}catch (e12930){var _e__9903__auto__ = e12930;
return false;
...
}catch (e12933){var _e__9903__auto__ = e12933;
return false;
...
}catch (e12935){var _e__9903__auto__ = e12935;
return false;
...
}catch (e12940){var _e__9903__auto__ = e12940;
return false;
}})())){
...
}catch (e12942){var _e__9903__auto__ = e12942;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__12944 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12945 = (function (){var or__5045__auto__ = config;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12945);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12944);
}});
});
...
while (G__12948__i < G__12948__a.length) {G__12948__a[G__12948__i] = arguments[G__12948__i + 0]; ++G__12948__i;}
  args = new cljs.core.IndexedSeq(G__12948__a,0,null);
} 
