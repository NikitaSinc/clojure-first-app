...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_29639 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_29639(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29645 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29645(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29652 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29652(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29667 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29667(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29673 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29673(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29679 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29679(reader);
}
});
...
var G__29886 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__29887 = s.append(c);
c = G__29886;
s = G__29887;
continue;
}
