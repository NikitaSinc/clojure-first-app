...
var G__42260 = request;
var G__42261 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__42260,G__42261) : ajax.formats.get_format.call(null,G__42260,G__42261));
} else {
...
return cljs.core.some((function (p1__42266_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__42266_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__42270){
var map__42271 = p__42270;
var map__42271__$1 = cljs.core.__destructure_map(map__42271);
var request = map__42271__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42271__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__42277 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__42277.cljs$core$IFn$_invoke$arity$1 ? fexpr__42277.cljs$core$IFn$_invoke$arity$1(response) : fexpr__42277.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__42279){
var map__42280 = p__42279;
var map__42280__$1 = cljs.core.__destructure_map(map__42280);
var request = map__42280__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42280__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__42278_SHARP_){
return ajax.formats.get_accept_entries(request,p1__42278_SHARP_);
